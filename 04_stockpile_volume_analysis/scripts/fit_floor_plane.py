...
def main() -> None:
    ...
    input_csv = project_root / "data" / "results" / "floor_sample_centroids.csv"
    output_csv = project_root / "data" / "results" / "floor_plane_fit.csv"
    output_txt = project_root / "data" / "results" / "floor_plane_equation.txt"
