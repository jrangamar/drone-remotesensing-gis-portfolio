...
def main() -> None:
    ...
    input_raster = (
        ...
        / "data"
        / "processed"
        / "p01_stockpile_height_supplied_boundary.tif"
    )
    cleaned_raster = (
        project_root
        / "data"
        / "processed"
        / "p01_stockpile_height_supplied_boundary_positive.tif"
    )
    output_csv = (
        project_root
        / "data"
        / "results"
        / "p01_supplied_boundary_metrics.csv"
    )
    ...
    metrics = {
        "pile_id": "P01",
        "base_method": "least-squares sloping plane with supplied Virtual-Survey perimeter",
