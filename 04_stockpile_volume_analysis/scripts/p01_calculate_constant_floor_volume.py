...
def main() -> None:
    ...
    input_raster = (
        ...
        / "data"
        / "processed"
        / "p01_stockpile_height_constant_floor.tif"
    )
    cleaned_raster = (
        project_root
        / "data"
        / "processed"
        / "p01_stockpile_height_constant_positive.tif"
    )
    output_csv = (
        project_root
        / "data"
        / "results"
        / "p01_constant_floor_metrics.csv"
    )
    ...
    metrics = {
        "pile_id": "P01",
        "base_method": "constant floor from mean of six floor-sample elevations",
